...
import { Shield, X, Monitor, Smartphone, Fingerprint, Search, Loader2, LogOut, RefreshCw } from 'lucide-react';
...
export const PasskeyManager = ({ isOpen, onClose }: PasskeyManagerProps) => {
    ...
    const handleSwitchWallet = async () => {
        try {
            ...
            addToast('Failed to switch wallet', 'error');
        }
    };
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="w-full max-w-sm sm:max-w-md bg-surface-dark/90 backdrop-blur-xl border border-surface-border rounded-xl shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]"
                    >
                            ...
                            {isScanning && (
                                ...
                                >
                                    ...
                                    <div className="text-center space-y-1 px-6">
                                        <div className="text-primary font-mono text-xs font-bold uppercase tracking-widest flex items-center gap-2 justify-center">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-black/40 border border-surface-border group hover:border-primary/30 transition-colors">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-xs sm:text-sm text-white font-medium text-nowrap overflow-hidden text-ellipsis max-w-[120px] sm:max-w-none">MacBook Pro M2</div>
                                                <div className="text-[9px] sm:text-[10px] text-green-500 font-mono flex items-center gap-1">
                                    ...
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-black/40 border border-surface-border group hover:border-primary/30 transition-colors">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-xs sm:text-sm text-white font-medium text-nowrap overflow-hidden text-ellipsis max-w-[120px] sm:max-w-none">iPhone 15 Pro</div>
                                                <div className="text-[9px] sm:text-[10px] text-slate-500 font-mono">Last seen 2h ago</div>
                                            </div>
                                        </div>
                                        <button className="text-[10px] text-slate-500 hover:text-red-400 font-mono font-bold transition-colors">REVOKE</button>
                                    </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-3 mt-4">
                                    <button
                                        ...
                                        className="py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/10 text-slate-400 hover:text-white rounded-lg transition-all flex items-center justify-center gap-2 font-mono text-[10px] font-bold uppercase tracking-widest"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="py-3 px-4 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 text-red-500 hover:text-white rounded-lg transition-all flex items-center justify-center gap-2 font-mono text-[10px] font-bold uppercase tracking-widest"
                                    >
